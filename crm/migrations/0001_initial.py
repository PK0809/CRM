# Generated by Django 5.2.3 on 2025-11-08 17:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(default='Default Terms', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quote_no', models.CharField(blank=True, max_length=100, unique=True)),
                ...
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Approved', 'Approved'), ('Rejected', 'Rejected'), ('Lost', 'Lost'), ('Invoiced', 'Invoiced')], default='Pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Unpaid', 'Unpaid'), ('Partial Paid', 'Partial Paid'), ('Paid', 'Paid'), ('Pending', 'Pending')], default='Unpaid', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('Referrals', 'Referrals'), ('Email', 'Email'), ('Social Media', 'Social Media'), ('Website', 'Website'), ('Justdial', 'Justdial'), ('Others', 'Others')], default='Referrals', max_length=50)),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Quoted', 'Quoted'), ('Won', 'Won'), ('Lost', 'Lost'), ('Rejected', 'Rejected')], default='Pending', max_length=20)),
                ('computed_status', models.CharField(blank=True, default='', max_length=20)),
                ('company_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.client')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('status', models.CharField(choices=[('Paid', 'Paid'), ('Partial Paid', 'Partial Paid'), ('Pending', 'Pending')], default='Pending', max_length=50)),
                ('remarks', models.TextField(blank=True, null=True)),
